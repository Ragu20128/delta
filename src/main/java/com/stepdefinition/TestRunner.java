...
@CucumberOptions(features = "src/test/resources/feature/moreMenu/BookCruiser.feature", glue = { "com.stepdefinition" }, 
plugin = {
		"com.resources.ExtentCucumberFormatter:", "json:src/main/resources/AutomationSuite/jsonReport.json",
